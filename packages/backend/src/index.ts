...
const consoleLog = (sdk: SDK, data: any) => {
...
const introspectGraphQL = async (
  sdk: SDK,
  params: { endpoint: string; headers?: Record<string, string> }
) => {
...
export type API = DefineAPI<{
  consoleLog: typeof consoleLog;
  introspectGraphQL: typeof introspectGraphQL;
}>;
